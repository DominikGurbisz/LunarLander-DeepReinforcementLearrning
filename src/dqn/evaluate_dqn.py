...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--video-folder", type=Path, default=Path("videos/dqn/eval"))
    parser.add_argument("--video-prefix", type=str, default="dqn_eval")
    parser.add_argument("--device", type=str, default="auto")
    parser.add_argument("--results-path", type=Path, default=Path("results/tables/dqn_eval_summary.json"))
