...
from src.a2c.model import PolicyNetwork


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate a trained A2C model")
    parser.add_argument("--model-path", type=Path, required=True)
    parser.add_argument("--episodes", type=int, default=20)
    parser.add_argument("--seed", type=int, default=1)
    parser.add_argument("--hidden-size", type=int, default=128)
    parser.add_argument("--record-video", action="store_true")
    parser.add_argument("--video-folder", type=Path, default=Path("videos/a2c/eval"))
    parser.add_argument("--video-prefix", type=str, default="a2c_eval")
    parser.add_argument("--device", type=str, default="auto")
    parser.add_argument("--results-path", type=Path, default=Path("results/tables/a2c_eval_summary.json"))
